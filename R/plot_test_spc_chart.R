...
#' Run SPC Chart Test with Advanced Highlighting with Phase Handling and Annotations
#'
...
#' @export
#' @importFrom ggplot2 ggplot element_line scale_color_manual geom_line geom_point geom_text geom_segment aes labs scale_x_discrete theme_minimal scale_x_date theme element_text element_blank scale_fill_manual
#' @importFrom lubridate parse_date_time
#' @importFrom grDevices rgb
#' @examples
#' data <- create_spc_data(your_data_frame, 'date', 'value', 'xbar')
#' annotations <- data.frame(
#'   serial_number = c(10, 20),
